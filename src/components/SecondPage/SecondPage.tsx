...
export const SecondPage = () => {
  return (
    <>
      ...
      `}</style>
      <header className="bg-[#E4C3A4] w-full min-h-screen overflow-x-hidden">
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-[40px] md:gap-[100px] justify-center items-center mt-[50px] px-4 pb-10">
          <div className="anim-card-1 w-full max-w-[436px] min-h-[630px] bg-[#EECA50] rounded-md text-left pb-6">
            <img
              src="/img/Frame256.png"
              alt="img"
              className="m-auto mt-[20px] w-full max-w-[90%] h-auto rounded-md object-contain"
            />
            <p className="font-[Inter] font-[800] text-[#454181] text-[24px] md:text-[28px] pl-[40px] md:pl-[60px] mt-[10px]">
              town hall 15 is here
            </p>
            <br />
            <p className="text-[#6661A8] font-[Inter] font-[600] pl-[40px] md:pl-[60px] text-[16px] md:text-[18px] pr-4">
              you can download this update now <br />
              from google play and enjoy all new <br /> features
            </p>
          ...
          <div className="anim-card-2 w-full max-w-[436px] min-h-[630px] bg-[#EECA50] rounded-md text-left pb-6">
            <img
              src="/img/image6.png"
              alt="img"
              className="m-auto mt-[20px] w-full max-w-[90%] h-auto rounded-md object-contain"
